...
\setbeamertemplate{title page}
{
  ...
  \vbox{%
  \vspace{-0.2ex}%
  \noindent\begin{tcolorbox}[enhanced,watermark graphics=photos/psi_in_mist.jpg, width=\paperwidth, height=0.667\paperwidth, watermark zoom=1.0, grow to left by=0.05\paperwidth, frame hidden, coltext=kgrey]
...
\begin{frame}{\footnotesize Maybe the real treasure is the python packages we made along the way}
    ...
    Also have unmerged tools for \texttt{oncvpsp} input and output files as well as Junfeng's custom \texttt{.dat} projector files (perhaps \texttt{oncvpsp-tools} Need to decide on the right home for these
