...
\tikzstyle{boxwhite} = [default, fill=white, rounded corners=0.1cm, text width=7cm, align=left]
...
\begin{frame}{Automating Wannierization}
   ...
   \includegraphics[width=0.3\textwidth]{figures/Li8.0.pao_2_2_1_0.png}
   \includegraphics[width=0.3\textwidth]{figures/Li8.0.pao_10_0_0_0.png}
...
\begin{frame}{Optimising the confining potential}
...
\begin{frame}{Problems with \texttt{oncvpsp.x}}
